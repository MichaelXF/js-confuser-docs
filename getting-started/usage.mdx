...
Obfuscates source code. Returns a [Promise](https://developer.mozilla.org/en-US/Web/JavaScript/Reference/Global_Objects/Promise) that resolves to an object of the obfuscated result.
...
Obfuscates a Babel AST. Returns a [Promise](https://developer.mozilla.org/en-US/Web/JavaScript/Reference/Global_Objects/Promise).
