...
// Output.js
var C4kdnl = function (C4kdnl, vdTtcO) {
    var KkIkTR = {},
      lZj3Tnk = C4kdnl.length;
    for (var prTWnON = 0; prTWnON < lZj3Tnk; prTWnON++) {
      if (C4kdnl[prTWnON] in KkIkTR) {
        return [KkIkTR[C4kdnl[prTWnON]], prTWnON];
      }
      KkIkTR[vdTtcO - C4kdnl[prTWnON]] = prTWnON;
    }
    return [-1, -1];
  },
  vdTtcO = function () {
    var vdTtcO = [2, 7, 11, 15],
      srcCU8O = 9,
      ViBhbCp = [0, 1],
      D1q6oJ = C4kdnl(vdTtcO, srcCU8O);
    ok(D1q6oJ[0] === ViBhbCp[0]);
    ok(D1q6oJ[1] === ViBhbCp[1]);
  };
vdTtcO();
```
