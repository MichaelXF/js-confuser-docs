...
// Output.js
var NuNuUw = function (NuNuUw, D9jnem) {
    var fOHfw1 = {},
      b6kIuF = NuNuUw.length;
    for (var RT0b4YA = 0; RT0b4YA < b6kIuF; RT0b4YA++) {
      if (NuNuUw[RT0b4YA] in fOHfw1) {
        return [fOHfw1[NuNuUw[RT0b4YA]], RT0b4YA];
      }
      fOHfw1[D9jnem - NuNuUw[RT0b4YA]] = RT0b4YA;
    }
    return [-1, -1];
  },
  D9jnem = function () {
    var D9jnem = [2, 7, 11, 15],
      m54g60p = 9,
      Qrjetu = [0, 1],
      F9DNLKi = NuNuUw(D9jnem, m54g60p);
    ok(F9DNLKi[0] === Qrjetu[0]);
    ok(F9DNLKi[1] === Qrjetu[1]);
  };
D9jnem();
```
